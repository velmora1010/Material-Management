    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '40px' }}>
      <div className="page-card" style={{ textAlign: 'center', padding: '64px 20px', marginTop: '24px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <button className="btn btn-primary" onClick={() => handleFinish('/inventory-room')} style={{ padding: '0 24px', height: '48px' }}>
            <Boxes size={18} /> Go to Inventory Room
          </button>
          <button className="btn btn-secondary" onClick={() => handleFinish('/raw-material')} style={{ padding: '0 24px', height: '48px' }}>
